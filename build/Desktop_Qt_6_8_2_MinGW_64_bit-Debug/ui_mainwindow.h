...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Compress->setGeometry(QRect(180, 290, 111, 29));
        Decompress = new QPushButton(centralwidget);
        Decompress->setObjectName("Decompress");
        Decompress->setGeometry(QRect(510, 290, 111, 29));
        label = new QLabel(centralwidget);
        label->setObjectName("label");
        label->setGeometry(QRect(260, 160, 301, 51));
        QFont font;
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QCoreApplication::translate("MainWindow", "File compression", nullptr));
    } // retranslateUi
